...
if __name__ == '__main__':
    ...
    s_prod = list(itertools.product(*s))
    print(s_prod[param_idx])
    ...
    params = {
        ...
        'lstm_dim': s_prod[param_idx][2],
        'dropout': s_prod[param_idx][0],  # 1 = no dropout, 0.5 = dropout
        'learning_rate': s_prod[param_idx][1],
